...
const CreatorHero = () => {
  ...
  const fullText = `The Hollywood Reporter India’s Creator A-List 2025, in collaboration with Ormax Media, ranks India’s 50 most influential digital creators who have redefined and expanded the meaning of entertainment not just in the country, but globally.
